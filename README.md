...
按调研对象性质分为四大类一级目录：`paper&blog/`（学术论文 / 博客 / 综述）、`framework/`（框架/内核/方法论框架）、`product/`（产品级系统）、`open-source-project/`（开源工具/项目）。各类下保留原研究主题的二级分组与目录层级。

```
paper&blog/                              # 学术论文 / 博客 / 综述调研（含 arXiv 编号 / 会议发表 / 博客观点）
├── recursive-self-improvement/           # 递归自我改进相关研究（按《A Taxonomy of Self-Evolving Agents》分类法重组）
...
│   ├── model-optimization/             # L3 优化模型（更新模型权重，当前为空占位）
...
├── recursive-self-improvement/           # 递归自我改进相关研究（按《A Taxonomy of Self-Evolving Agents》分类法重组，与 paper&blog/ 对称）
│   ├── artifact-optimization/           # L1 优化产物（不动模型权重）
│   │   ├── auto-research/               # Karpathy autoresearch 项目调研
│   │   └── pi-auto-research/            # pi-autoresearch 项目调研
│   ├── harness-optimization/            # L2 优化 Harness（当前为空占位）
│   │   ├── single-agent/
│   │   └── multi-agent/
│   ├── model-optimization/             # L3 优化模型（当前为空占位）
│   └── joint-optimization/             # 联合优化（当前为空占位）
...
### 优化产物 (Artifact Optimization)（paper&blog/recursive-self-improvement/artifact-optimization/）

按《A Taxonomy of Self-Evolving Agents》分类法，优化外部产物、不动模型权重的 L1 工作。

#### 4. Arbor

**文件**: [paper&blog/recursive-self-improvement/artifact-optimization/arbor/report.md](paper&blog/recursive-self-improvement/artifact-optimization/arbor/report.md)
...
**文件**: [paper&blog/recursive-self-improvement/artifact-optimization/ml-evolve/report.md](paper&blog/recursive-self-improvement/artifact-optimization/ml-evolve/report.md)
...
**文件**: [open-source-project/recursive-self-improvement/artifact-optimization/auto-research/report.md](open-source-project/recursive-self-improvement/artifact-optimization/auto-research/report.md)
...
**文件**: [open-source-project/recursive-self-improvement/artifact-optimization/pi-auto-research/report.md](open-source-project/recursive-self-improvement/artifact-optimization/pi-auto-research/report.md)
...
### 优化 Harness (Harness Optimization)（paper&blog/recursive-self-improvement/harness-optimization/）

按分类法，优化 agent 自身的 prompt/memory/tool/skill、不动模型权重的 L2 工作，分单 agent 与多 agent 两组。Hermes（product/）与 Better Harness（framework/）属同类但位于其它一级目录，列在本节末作索引。

#### 8. Agentic Harness Engineering（单 agent）

**文件**: [paper&blog/recursive-self-improvement/harness-optimization/single-agent/agentic-harness-engineering/report.md](paper&blog/recursive-self-improvement/harness-optimization/single-agent/agentic-harness-engineering/report.md)
...
**文件**: [paper&blog/recursive-self-improvement/harness-optimization/single-agent/auto-harness-deepmind/report.md](paper&blog/recursive-self-improvement/harness-optimization/single-agent/auto-harness-deepmind/report.md)
...
**文件**: [paper&blog/recursive-self-improvement/harness-optimization/single-agent/life-harness/report.md](paper&blog/recursive-self-improvement/harness-optimization/single-agent/life-harness/report.md)
...
**文件**: [paper&blog/recursive-self-improvement/harness-optimization/single-agent/memo-harness/report.md](paper&blog/recursive-self-improvement/harness-optimization/single-agent/memo-harness/report.md)
...
**文件**: [paper&blog/recursive-self-improvement/harness-optimization/single-agent/meta-evolution-harness/report.md](paper&blog/recursive-self-improvement/harness-optimization/single-agent/meta-evolution-harness/report.md)
...
**文件**: [paper&blog/recursive-self-improvement/harness-optimization/single-agent/meta-harness/report.md](paper&blog/recursive-self-improvement/harness-optimization/single-agent/meta-harness/report.md)
...
**文件**: [paper&blog/recursive-self-improvement/harness-optimization/single-agent/retro-harness/report.md](paper&blog/recursive-self-improvement/harness-optimization/single-agent/retro-harness/report.md)
...
**文件**: [paper&blog/recursive-self-improvement/harness-optimization/single-agent/reward-harness/report.md](paper&blog/recursive-self-improvement/harness-optimization/single-agent/reward-harness/report.md)
...
**文件**: [paper&blog/recursive-self-improvement/harness-optimization/single-agent/self-harness/report.md](paper&blog/recursive-self-improvement/harness-optimization/single-agent/self-harness/report.md)
...
**文件**: [paper&blog/recursive-self-improvement/harness-optimization/multi-agent/autogenesis/report.md](paper&blog/recursive-self-improvement/harness-optimization/multi-agent/autogenesis/report.md)
...
**文件**: [paper&blog/recursive-self-improvement/harness-optimization/multi-agent/evo-mas/report.md](paper&blog/recursive-self-improvement/harness-optimization/multi-agent/evo-mas/report.md)
...
**文件**: [paper&blog/recursive-self-improvement/harness-optimization/multi-agent/skill-mas/report.md](paper&blog/recursive-self-improvement/harness-optimization/multi-agent/skill-mas/report.md)
...
#### 21. LangChain Better Harness（同类索引，位于 framework/）
...
### 联合优化 (Joint Optimization)（paper&blog/recursive-self-improvement/joint-optimization/）

按分类法"三层边界模糊、未来一起生长"，同时优化 Harness 与模型权重的工作。

#### 22. Continual Harness

**文件**: [paper&blog/recursive-self-improvement/joint-optimization/continual-harness/report.md](paper&blog/recursive-self-improvement/joint-optimization/continual-harness/report.md)
...
**文件**: [paper&blog/recursive-self-improvement/joint-optimization/harness_x/report.md](paper&blog/recursive-self-improvement/joint-optimization/harness_x/report.md)
...
### 综述 / 观点 (Survey)（paper&blog/recursive-self-improvement/survey/）

#### 24. A Taxonomy of Self-Evolving Agents

**文件**: [paper&blog/recursive-self-improvement/survey/a-taxonomy-of-self-evolving-agents/report.md](paper&blog/recursive-self-improvement/survey/a-taxonomy-of-self-evolving-agents/report.md)
...
### 上下文工程 (Context Engineering)（paper&blog/）

#### 25. TokenPilot

**文件**: [paper&blog/context_engineering/token-pilot/report.md](paper&blog/context_engineering/token-pilot/report.md)
...
**文件**: [paper&blog/context_engineering/self-gc/report.md](paper&blog/context_engineering/self-gc/report.md)
...
### Agent 强化学习 (Agent RL)（paper&blog/）
