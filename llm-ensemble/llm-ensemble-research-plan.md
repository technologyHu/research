...
| 序号 | 工作 | 优先级 | 状态 | 笔记/产出 | 备注 |
|---|---|---|---|---|---|
| 1.1 | Mixture-of-Agents 原始（2406.04692） | ⭐⭐⭐ | ✅ | [report.md](./moa/paper/report.md) | 所有变体 baseline，已建 proposer/aggregator 框架 |
| 1.2 | Together MoA 工程实现 | ⭐⭐⭐ | ✅ | [report.md](./moa/paper/report.md) §4 | 部署形态，代码分析章节已覆盖 moa.py/advanced-moa.py |
